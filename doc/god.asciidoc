...
You can supply a shorthand to the log command that will match one of your
...
You can watch all the logs from a Watch group by using the group's name:

```terminal
$ sudo god log all_my_daemons
```
